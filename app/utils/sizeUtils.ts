...
export const SIZE_ALIASES: Record<string, number> = {
  // x-small (rank 1)
  "xs": 1, "xsm": 1, "xsmall": 1, "x-small": 1,
  "extra small": 1, "extra-small": 1, "xtra small": 1,
  // small (rank 2)
  "sm": 2, "sml": 2, "small": 2,
  // medium (rank 3)
  "md": 3, "med": 3, "medium": 3,
  ...
  "lg": 4, "lrg": 4, "large": 4,
  // x-large (rank 5)
  "xl": 5, "xlg": 5, "xlarge": 5, "x-large": 5,
  "extra large": 5, "extra-large": 5, "xtra large": 5,
  // xx-large (rank 6)
  "xxl": 6, "2xl": 6, "xxlarge": 6, "xx-large": 6,
  "double xl": 6, "2x large": 6, "2x-large": 6,
  // xxx-large (rank 7)
  "xxxl": 7, "3xl": 7, "xxxlarge": 7, "xxx-large": 7,
  "triple xl": 7, "3x large": 7, "3x-large": 7,
  // one size (rank 8)
  "os": 8, "osfm": 8, "osfa": 8,
  "one size": 8, "onesize": 8, "one-size": 8,
  "one size fits all": 8, "one size fits most": 8,
  // no size (rank 9)
  "ns": 9, "nosize": 9, "no-size": 9, "no size": 9,
};
